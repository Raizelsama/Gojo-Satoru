...
⭐✑ مرحباً👋 @${num.split("@")[0]},
⭐✑ مرحباَ بك في ${metadata.subject}

⭐✑ Description: ${metadata.desc}

⭐✑ *مرحبـــــــاً بك في بيتك الثاني*
نستقبلك بباقات من الأقحوان والياسمين ونصافحك والحّب أكفنا لنهديك أجمل معانينا ونغرف من همس الكّلام أعذبه ومن قوافي.. القصيد أجزله ننتظر رسم إحساسك وبوح قلمك، ورقي فكرك أهلاً بك من هنا لحد السماء.
*المهم منور/ة*😝!`} )
