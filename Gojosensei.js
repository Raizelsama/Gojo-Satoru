...
زوجناكم لأنكم تناسبو بعض❤️💖👀`
            let menst = [orang, jodoh]
            let buttons = [
                        { buttonId: '❤️اتفق', buttonText: { displayText: 'مبروك♥' }, type: 1 }
                    ]
...
case 'halah': case 'hilih': case 'huluh': case 'heleh': case 'holoh':
	...
	break
	    case 'تسمية': case 'setgcname': case 'setsubject': {
                if (!m.isGroup) return replay(`${mess.group}`)
                if (!isBotAdmins) return replay(`${mess.botAdmin}`)
...
break
	    ...
	    break
            case 'listpc': case 'pclist': {
             ...
             break
             case 'المتصلين': case 'onlinelistxxx': {
...
break
        ...
        let buttons = [
                    {buttonId: `gimage ${text}`, buttonText: {displayText: '➡️➡️الصورة التالية➡️➡️'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: images },
...
break
		...
		let { quotesAnime } = require('./lib/scraper')
                ...
                result = anu[Math.floor(Math.random() * anu.length)]
                let buttons = [
                    {buttonId: `quotesanime`, buttonText: {displayText: '➡️التـــالي➡️'}, type: 1}
                ]
                let buttonMessage = {
	        ...
	        case 'motivasi': case 'motivationalquote': case 'bucinquote': case 'katasenja': case 'puisi': {
                ...
                let buttons = [
                    {buttonId: `motivasi`, buttonText: {displayText: '➡️التـالي➡️'}, type: 1}
                ]
                let buttonMessage = {
